            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <c:forEach var="product" items="${wishlist}">
                        ...
                        <tr>
                            <td>
                                <img src="/images/product/${product.image}" class="img-fluid rounded" style="width: 80px; height: 80px;" alt="Product Image">
                            </td>
                            <td>${product.name}</td>
                            <td><fmt:formatNumber type="number" value="${product.price}" /> đ</td>
                            <td>1</td>
                            <td><fmt:formatNumber type="number" value="${itemTotal}" /> đ</td>
                        </tr>
                    </c:forEach>
                </c:otherwise>
            </c:choose>
    ...
    <c:if test="${not empty wishlist}">
        <div class="bg-light rounded p-4">
            ...
            <div class="d-flex justify-content-between mb-3">
                <h5>Subtotal:</h5>
                <p><fmt:formatNumber type="number" value="${totalPrice}" /> đ</p>
            </div>
