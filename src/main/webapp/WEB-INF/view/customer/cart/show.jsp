                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/delete-cart-product/${cartDetail.id}">
                                        ...
                                        <button class="btn btn-md rounded-circle bg-light border mt-4 mr-4">
                                ...
                                <td class="align-middle">
                                    <c:choose>
                                        <c:when test="${cartDetail.product.quantity > 0}">
                                            <span class="text-successfully" style="color: green">In stock</span>
                                        </c:when>
                                        <c:otherwise>
                ...
                <div class="mt-5 row g-4 justify-content-start">
                    <div class="col-12 col-md-8">
                        <div class="bg-light rounded">
                            <div class="p-4">
                                <h1 class="display-6 mb-4">Information<span class="fw-normal">Order</span></h1>
