...
<footer class="footer">
    <div class="footer-container">
        <h4>Gundam Model Shop Online</h4>
        <ul>
            <li>FPT Software Academy
                600 Nguyen Van Cu Street, An Binh Ward, Ninh Kieu District, Can Tho City, Vietnam</li>
            <li>Phone number: 09.166.12354 </li>
            <li>Email: munndangiu3113@gmail.com</li>
            <li>FACEBOOK: <a href="https://www.facebook.com/Gunplacantho/" style="color: white; text-decoration: underline;">Facebook.com</a></li>
            <li>Business registration number: 0123456789</li>
            <li>Date issued: 05/01/2025</li>
        </ul>
    </div>
    <div class="footer-bottom">
        <p>Copyright © 2025 GunDam.com.vn. Thiết kế Website - Group-04 FPT Software Can Tho</p>
    </div>
</footer>
