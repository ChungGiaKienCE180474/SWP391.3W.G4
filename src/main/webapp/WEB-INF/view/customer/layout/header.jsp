...
<head>
    ...
    <style>
        ...
        .d-flex.m-3.me-0 {
            display: flex;
            align-items: center;
            gap: 10px; /* Thêm khoảng cách nhỏ giữa các mục */
        ...
        .nav-link {
            ...
            font-size: 13px; /* Giảm kích thước chữ để vừa hàng */
            padding: 0.5rem 0.5rem; /* Giảm padding để tiết kiệm không gian */
        }
        .nav-item {
            padding: 0 2px; /* Giảm khoảng cách giữa các mục */
        }
        /* Responsive: Điều chỉnh trên màn hình nhỏ */
        @media screen and (max-width: 768px) {
            .nav-search {
                width: 120px; /* Giảm chiều rộng thanh tìm kiếm trên mobile */
            }
            .nav-search:focus {
                width: 150px;
            }
            .nav-link {
                font-size: 11px; /* Giảm thêm kích thước chữ trên mobile */
                padding: 0.3rem 0.4rem; /* Giảm padding trên mobile */
            }
            .nav-item {
                padding: 0 1px; /* Giảm khoảng cách trên mobile */
            }
        }
    </style>
</head>
            ...
            <div class="collapse navbar-collapse bg-white justify-content-between mx-5" id="navbarCollapse">
                <div class="navbar-nav">
                    <li class="nav-item logo-item">
                        <a href="/"><img class="nav-logo" style="width: 50px" src="/client/img/logo.jpg" alt=""></a>
                    </li>
                    <a href="/" class="nav-item nav-link active fw-bold">Home Page</a>
                    <!-- Search Form -->
                    <form action="/search" method="get" class="nav-item search-bar d-flex">
                        <input class="nav-search" type="text" name="query" placeholder="What do you need..." required>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link fw-bold dropdown-toggle" data-bs-toggle="dropdown">Category</a>
                ...
                <div class="d-flex m-3 me-0">
                    <c:if test="${not empty pageContext.request.userPrincipal}">
                        ...
                        <!-- Wishlist -->
                        <a href="/wishlist" class="position-relative me-4 my-auto wishlist-icon" title="Wishlist">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="dropdown my-auto">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-4" aria-labelledby="dropdownMenuLink">
                                <li class="d-flex align-items-center flex-column" style="min-width: 300px;">
                                    <img style="width: 150px; height: 150px; border-radius: 50%;" src="/images/avatar/${sessionScope.avatar}" alt="User Avatar" />
                                    <div class="text-center my-3">
                                        <c:out value="${sessionScope.username}" />
                                    </div>
                                </li>
                                <li><a class="dropdown-item" href="/customer/profile/${sessionScope.id}">Account Management</a></li>
