                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row g-4">
                                            <div class="col-12" id="factoryFilter">
                                                <div class="mb-2"><b>Production company</b></div>
                                            ...
                                            <div class="col-12" id="targetFilter">
                                                <div class="mb-2"><b>Purpose of use</b></div>
                                            ...
                                            <div class="col-12" id="priceFilter">
                                                <div class="mb-2"><b>Price level</b></div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="price-4"
                                                        value="15-20-trieu">
                                                    <label class="form-check-label" for="price-4">Between 15 - 20
                                                        million</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="price-5"
                                                        value="tren-20-trieu">
                                                    <label class="form-check-label" for="price-5">Above 20
                                                        million</label>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="sort-1">Price increases
                                                            gradually</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="sort-2"
                                                            value="gia-giam-dan" name="radio-sort">
                                                        <label class="form-check-label" for="sort-2">Prices decrease
                                                            gradually</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
